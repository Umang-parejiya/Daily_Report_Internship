...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const passwordInput = document.querySelector('input[placeholder*="strong password"]');
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            const password = form.querySelector('input[placeholder*="strong password"]');
            ...
            alert('Account created successfully! Welcome to Easy-Cart!');
    ...
    termsLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            alert(`${type} will open in a new window.`);
        });
    });
});
</script>
